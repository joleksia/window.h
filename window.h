...
# define WINDOW_KEYCODE_1 WINDOW_KEYCODE_1

    WINDOW_KEYCODE_2 = 0x001f,
# define WINDOW_KEYCODE_2 WINDOW_KEYCODE_2

    WINDOW_KEYCODE_3 = 0x0020,
# define WINDOW_KEYCODE_3 WINDOW_KEYCODE_3

    WINDOW_KEYCODE_4 = 0x0021,
# define WINDOW_KEYCODE_4 WINDOW_KEYCODE_4

    WINDOW_KEYCODE_5 = 0x0022,
# define WINDOW_KEYCODE_5 WINDOW_KEYCODE_5

    WINDOW_KEYCODE_6 = 0x0023,
# define WINDOW_KEYCODE_6 WINDOW_KEYCODE_6

    WINDOW_KEYCODE_7 = 0x0024,
# define WINDOW_KEYCODE_7 WINDOW_KEYCODE_7

    WINDOW_KEYCODE_8 = 0x0025,
# define WINDOW_KEYCODE_8 WINDOW_KEYCODE_8

    WINDOW_KEYCODE_9 = 0x0026,
# define WINDOW_KEYCODE_9 WINDOW_KEYCODE_9

    WINDOW_KEYCODE_0 = 0x0027,
# define WINDOW_KEYCODE_0 WINDOW_KEYCODE_0

    WINDOW_KEYCODE_RETURN = 0x0028,
# define WINDOW_KEYCODE_RETURN WINDOW_KEYCODE_RETURN
...
# define WINDOW_KEYCODE_OPENBRACKET WINDOW_KEYCODE_OPENBRACKET

    WINDOW_KEYCODE_CLOSEBRACKET = 0x0030,
# define WINDOW_KEYCODE_CLOSEBRACKET WINDOW_KEYCODE_CLOSEBRACKET

    WINDOW_KEYCODE_BACKSLASH = 0x0031,
# define WINDOW_KEYCODE_BACKSLASH WINDOW_KEYCODE_BACKSLASH

    WINDOW_KEYCODE_NONUSHASH = 0x0032,
# define WINDOW_KEYCODE_NONUSHASH WINDOW_KEYCODE_NONUSHASH
...
# define WINDOW_KEYCODE_KP_SLASH WINDOW_KEYCODE_KP_SLASH

    WINDOW_KEYCODE_KP_ASTERISK = 0x0055,
# define WINDOW_KEYCODE_KP_ASTERISK WINDOW_KEYCODE_KP_ASTERISK

    WINDOW_KEYCODE_KP_MINUS = 0x0056,
# define WINDOW_KEYCODE_KP_MINUS WINDOW_KEYCODE_KP_MINUS

    WINDOW_KEYCODE_KP_PLUS = 0x0057,
# define WINDOW_KEYCODE_KP_PLUS WINDOW_KEYCODE_KP_PLUS

    WINDOW_KEYCODE_KP_ENTER = 0x0058,
# define WINDOW_KEYCODE_KP_ENTER WINDOW_KEYCODE_KP_ENTER

    WINDOW_KEYCODE_KP_1 = 0x0059,
# define WINDOW_KEYCODE_KP_1 WINDOW_KEYCODE_KP_1

    WINDOW_KEYCODE_KP_2 = 0x005a,
# define WINDOW_KEYCODE_KP_2 WINDOW_KEYCODE_KP_2

    WINDOW_KEYCODE_KP_3 = 0x005b,
# define WINDOW_KEYCODE_KP_3 WINDOW_KEYCODE_KP_3

    WINDOW_KEYCODE_KP_4 = 0x005c,
# define WINDOW_KEYCODE_KP_4 WINDOW_KEYCODE_KP_4

    WINDOW_KEYCODE_KP_5 = 0x005d,
# define WINDOW_KEYCODE_KP_5 WINDOW_KEYCODE_KP_5

    WINDOW_KEYCODE_KP_6 = 0x005e,
# define WINDOW_KEYCODE_KP_6 WINDOW_KEYCODE_KP_6

    WINDOW_KEYCODE_KP_7 = 0x005f,
# define WINDOW_KEYCODE_KP_7 WINDOW_KEYCODE_KP_7

    WINDOW_KEYCODE_KP_8 = 0x0060,
# define WINDOW_KEYCODE_KP_8 WINDOW_KEYCODE_KP_8

    WINDOW_KEYCODE_KP_9 = 0x0061,
# define WINDOW_KEYCODE_KP_9 WINDOW_KEYCODE_KP_9

    WINDOW_KEYCODE_KP_0 = 0x0062,
# define WINDOW_KEYCODE_KP_0 WINDOW_KEYCODE_KP_0

    WINDOW_KEYCODE_KP_DELETE = 0x0063,
# define WINDOW_KEYCODE_KP_PERIOD WINDOW_KEYCODE_KP_PERIOD

    WINDOW_KEYCODE_NONUSSLASH = 0x0064,
# define WINDOW_KEYCODE_NONUSSLASH WINDOW_KEYCODE_NONUSSLASH

    WINDOW_KEYCODE_APPLICATION = 0x0065,
# define WINDOW_KEYCODE_APPLICATION WINDOW_KEYCODE_APPLICATION

    WINDOW_KEYCODE_POWER = 0x0066,
# define WINDOW_KEYCODE_POWER WINDOW_KEYCODE_POWER

    WINDOW_KEYCODE_KP_EQUAL = 0x0067,
# define WINDOW_KEYCODE_KP_EQUAL WINDOW_KEYCODE_KP_EQUAL

    WINDOW_KEYCODE_F13 = 0x0068,
# define WINDOW_KEYCODE_F13 WINDOW_KEYCODE_F13

    WINDOW_KEYCODE_F14 = 0x0069,
# define WINDOW_KEYCODE_F14 WINDOW_KEYCODE_F14

    WINDOW_KEYCODE_F15 = 0x006a,
# define WINDOW_KEYCODE_F15 WINDOW_KEYCODE_F15

    WINDOW_KEYCODE_F16 = 0x006b,
# define WINDOW_KEYCODE_F16 WINDOW_KEYCODE_F16

    WINDOW_KEYCODE_F17 = 0x006c,
# define WINDOW_KEYCODE_F17 WINDOW_KEYCODE_F17

    WINDOW_KEYCODE_F18 = 0x006d,
# define WINDOW_KEYCODE_F18 WINDOW_KEYCODE_F18

    WINDOW_KEYCODE_F19 = 0x006e,
# define WINDOW_KEYCODE_F19 WINDOW_KEYCODE_F19

    WINDOW_KEYCODE_F20 = 0x006f,
# define WINDOW_KEYCODE_F20 WINDOW_KEYCODE_F20

    WINDOW_KEYCODE_F21 = 0x0070,
# define WINDOW_KEYCODE_F21 WINDOW_KEYCODE_F21

    WINDOW_KEYCODE_F22 = 0x0071,
# define WINDOW_KEYCODE_F22 WINDOW_KEYCODE_F22

    WINDOW_KEYCODE_F23 = 0x0072,
# define WINDOW_KEYCODE_F23 WINDOW_KEYCODE_F23

    WINDOW_KEYCODE_F24 = 0x0073,
# define WINDOW_KEYCODE_F24 WINDOW_KEYCODE_F24

    WINDOW_KEYCODE_EXECUTE = 0x0074,
# define WINDOW_KEYCODE_EXECUTE WINDOW_KEYCODE_EXECUTE

    WINDOW_KEYCODE_HELP = 0x0075,
# define WINDOW_KEYCODE_HELP WINDOW_KEYCODE_HELP

    WINDOW_KEYCODE_MENU = 0x0076,
# define WINDOW_KEYCODE_MENU WINDOW_KEYCODE_MENU

    WINDOW_KEYCODE_SELECT = 0x0077,
# define WINDOW_KEYCODE_SELECT WINDOW_KEYCODE_SELECT

    WINDOW_KEYCODE_STOP = 0x0078,
# define WINDOW_KEYCODE_STOP WINDOW_KEYCODE_STOP

    WINDOW_KEYCODE_AGAIN = 0x0079,
# define WINDOW_KEYCODE_AGAIN WINDOW_KEYCODE_AGAIN

    WINDOW_KEYCODE_UNDO = 0x007a,
# define WINDOW_KEYCODE_UNDO WINDOW_KEYCODE_UNDO

    WINDOW_KEYCODE_CUT = 0x007b,
# define WINDOW_KEYCODE_CUT WINDOW_KEYCODE_CUT

    WINDOW_KEYCODE_COPY = 0x007c,
# define WINDOW_KEYCODE_COPY WINDOW_KEYCODE_COPY

    WINDOW_KEYCODE_PASTE = 0x007d,
# define WINDOW_KEYCODE_PASTE WINDOW_KEYCODE_PASTE

    WINDOW_KEYCODE_FIND = 0x007e,
# define WINDOW_KEYCODE_FIND WINDOW_KEYCODE_FIND

    WINDOW_KEYCODE_MUTE = 0x007f,
# define WINDOW_KEYCODE_MUTE WINDOW_KEYCODE_MUTE

    WINDOW_KEYCODE_VOLUMEUP = 0x0080,
# define WINDOW_KEYCODE_VOLUMEUP WINDOW_KEYCODE_VOLUMEUP

    WINDOW_KEYCODE_VOLUMEDOWN = 0x0081,
# define WINDOW_KEYCODE_VOLUMEDOWN WINDOW_KEYCODE_VOLUMEDOWN

    WINDOW_KEYCODE_LOCKING_CAPSLOCK = 0x0082,
# define WINDOW_KEYCODE_LOCKING_CAPSLOCK WINDOW_KEYCODE_LOCKING_CAPSLOCK

    WINDOW_KEYCODE_LOCKING_NUMLOCK = 0x0083,
# define WINDOW_KEYCODE_LOCKING_NUMLOCK WINDOW_KEYCODE_LOCKING_NUMLOCK

    WINDOW_KEYCODE_LOCKING_SCROLLLOCK = 0x0084,
# define WINDOW_KEYCODE_LOCKING_SCROLLLOCK WINDOW_KEYCODE_LOCKING_SCROLLLOCK

    WINDOW_KEYCODE_KP_COMMA = 0x0085,
# define WINDOW_KEYCODE_KP_COMMA WINDOW_KEYCODE_KP_COMMA

    WINDOW_KEYCODE_EQUALSIGN = 0x0086,
# define WINDOW_KEYCODE_EQUALSIGN WINDOW_KEYCODE_EQUALSIGN

    WINDOW_KEYCODE_INTERNATIONAL1 = 0x0087,
# define WINDOW_KEYCODE_INTERNATIONAL1 WINDOW_KEYCODE_INTERNATIONAL1

    WINDOW_KEYCODE_INTERNATIONAL2 = 0x0088,
# define WINDOW_KEYCODE_INTERNATIONAL2 WINDOW_KEYCODE_INTERNATIONAL2

    WINDOW_KEYCODE_INTERNATIONAL3 = 0x0089,
# define WINDOW_KEYCODE_INTERNATIONAL3 WINDOW_KEYCODE_INTERNATIONAL3

    WINDOW_KEYCODE_INTERNATIONAL4 = 0x008a,
# define WINDOW_KEYCODE_INTERNATIONAL4 WINDOW_KEYCODE_INTERNATIONAL4

    WINDOW_KEYCODE_INTERNATIONAL5 = 0x008b,
# define WINDOW_KEYCODE_INTERNATIONAL5 WINDOW_KEYCODE_INTERNATIONAL5

    WINDOW_KEYCODE_INTERNATIONAL6 = 0x008c,
# define WINDOW_KEYCODE_INTERNATIONAL6 WINDOW_KEYCODE_INTERNATIONAL6

    WINDOW_KEYCODE_INTERNATIONAL7 = 0x008d,
# define WINDOW_KEYCODE_INTERNATIONAL7 WINDOW_KEYCODE_INTERNATIONAL7

    WINDOW_KEYCODE_INTERNATIONAL8 = 0x008e,
# define WINDOW_KEYCODE_INTERNATIONAL8 WINDOW_KEYCODE_INTERNATIONAL8

    WINDOW_KEYCODE_INTERNATIONAL9 = 0x008f,
# define WINDOW_KEYCODE_INTERNATIONAL9 WINDOW_KEYCODE_INTERNATIONAL9

    WINDOW_KEYCODE_LANG1 = 0x0090,
# define WINDOW_KEYCODE_LANG1 WINDOW_KEYCODE_LANG1

    WINDOW_KEYCODE_LANG2 = 0x0091,
# define WINDOW_KEYCODE_LANG2 WINDOW_KEYCODE_LANG2

    WINDOW_KEYCODE_LANG3 = 0x0092,
# define WINDOW_KEYCODE_LANG3 WINDOW_KEYCODE_LANG3

    WINDOW_KEYCODE_LANG4 = 0x0093,
# define WINDOW_KEYCODE_LANG4 WINDOW_KEYCODE_LANG4

    WINDOW_KEYCODE_LANG5 = 0x0094,
# define WINDOW_KEYCODE_LANG5 WINDOW_KEYCODE_LANG5

    WINDOW_KEYCODE_LANG6 = 0x0095,
# define WINDOW_KEYCODE_LANG6 WINDOW_KEYCODE_LANG6

    WINDOW_KEYCODE_LANG7 = 0x0096,
# define WINDOW_KEYCODE_LANG7 WINDOW_KEYCODE_LANG7

    WINDOW_KEYCODE_LANG8 = 0x0097,
# define WINDOW_KEYCODE_LANG8 WINDOW_KEYCODE_LANG8

    WINDOW_KEYCODE_LANG9 = 0x0098,
# define WINDOW_KEYCODE_LANG9 WINDOW_KEYCODE_LANG9

    WINDOW_KEYCODE_ALTENRATEERASE = 0x0099,
# define WINDOW_KEYCODE_ALTENRATEERASE WINDOW_KEYCODE_ALTENRATEERASE

    WINDOW_KEYCODE_SYSREQ = 0x009a,
# define WINDOW_KEYCODE_SYSREQ WINDOW_KEYCODE_SYSREQ

    WINDOW_KEYCODE_CANCEL = 0x009b,
# define WINDOW_KEYCODE_CANCEL WINDOW_KEYCODE_CANCEL

    WINDOW_KEYCODE_CLEAR = 0x009c,
# define WINDOW_KEYCODE_CLEAR WINDOW_KEYCODE_CLEAR

    WINDOW_KEYCODE_PRIOR = 0x009d,
# define WINDOW_KEYCODE_PRIOR WINDOW_KEYCODE_PRIOR

    WINDOW_KEYCODE_RETURN2 = 0x009e,
# define WINDOW_KEYCODE_RETURN2 WINDOW_KEYCODE_RETURN2

    WINDOW_KEYCODE_SEPARATOR = 0x009f,
# define WINDOW_KEYCODE_SEPARATOR WINDOW_KEYCODE_SEPARATOR

    WINDOW_KEYCODE_OUT = 0x00a0,
# define WINDOW_KEYCODE_OUT WINDOW_KEYCODE_OUT

    WINDOW_KEYCODE_OPER = 0x00a1,
# define WINDOW_KEYCODE_OPER WINDOW_KEYCODE_OPER

    WINDOW_KEYCODE_CLEARAGAIN = 0x00a2,
# define WINDOW_KEYCODE_CLEARAGAIN WINDOW_KEYCODE_CLEARAGAIN

    WINDOW_KEYCODE_CRSEL = 0x00a3,
# define WINDOW_KEYCODE_CRSEL WINDOW_KEYCODE_CRSEL

    WINDOW_KEYCODE_EXSEL = 0x00a4,
# define WINDOW_KEYCODE_EXSEL WINDOW_KEYCODE_EXSEL

    /* 0x00a5 - 0x00af: reserved */

    WINDOW_KEYCODE_KP_00 = 0x00b0,
# define WINDOW_KEYCODE_KP_00 WINDOW_KEYCODE_KP_00

    WINDOW_KEYCODE_KP_000 = 0x00b1,
# define WINDOW_KEYCODE_KP_000 WINDOW_KEYCODE_KP_000

    WINDOW_KEYCODE_SEPARATOR_THOUSANDS = 0x00b2,
# define WINDOW_KEYCODE_SEPARATOR_THOUSANDS WINDOW_KEYCODE_SEPARATOR_THOUSANDS

    WINDOW_KEYCODE_SEPARATOR_DECIMAL = 0x00b3,
# define WINDOW_KEYCODE_SEPARATOR_DECIMAL WINDOW_KEYCODE_SEPARATOR_DECIMAL

    WINDOW_KEYCODE_CURRENCY_UNIT = 0x00b4,
# define WINDOW_KEYCODE_CURRENCY_UNIT WINDOW_KEYCODE_CURRENCY_UNIT

    WINDOW_KEYCODE_CURRENCY_SUBUNIT = 0x00b5,
# define WINDOW_KEYCODE_CURRENCY_SUBUNIT WINDOW_KEYCODE_CURRENCY_SUBUNIT

    WINDOW_KEYCODE_KP_OPENPAREN = 0x00b6,
# define WINDOW_KEYCODE_KP_OPENPAREN WINDOW_KEYCODE_KP_OPENPAREN

    WINDOW_KEYCODE_KP_CLOSEPAREN = 0x00b7,
# define WINDOW_KEYCODE_KP_CLOSEPAREN WINDOW_KEYCODE_KP_CLOSEPAREN

    WINDOW_KEYCODE_KP_OPENCURLY = 0x00b8,
# define WINDOW_KEYCODE_KP_OPENCURLY WINDOW_KEYCODE_KP_OPENCURLY

    WINDOW_KEYCODE_KP_CLOSECURLY = 0x00b9,
# define WINDOW_KEYCODE_KP_CLOSECURLY WINDOW_KEYCODE_KP_CLOSECURLY

    WINDOW_KEYCODE_KP_TAB = 0x00ba,
# define WINDOW_KEYCODE_KP_TAB WINDOW_KEYCODE_KP_TAB

    WINDOW_KEYCODE_KP_BACKSPACE = 0x00bb,
# define WINDOW_KEYCODE_KP_BACKSPACE WINDOW_KEYCODE_KP_BACKSPACE

    WINDOW_KEYCODE_KP_A = 0x00bc,
# define WINDOW_KEYCODE_KP_A WINDOW_KEYCODE_KP_A

    WINDOW_KEYCODE_KP_B = 0x00bd,
# define WINDOW_KEYCODE_KP_B WINDOW_KEYCODE_KP_B

    WINDOW_KEYCODE_KP_C = 0x00be,
# define WINDOW_KEYCODE_KP_C WINDOW_KEYCODE_KP_C

    WINDOW_KEYCODE_KP_D = 0x00bf,
# define WINDOW_KEYCODE_KP_D WINDOW_KEYCODE_KP_D

    WINDOW_KEYCODE_KP_E = 0x00c0,
# define WINDOW_KEYCODE_KP_E WINDOW_KEYCODE_KP_E

    WINDOW_KEYCODE_KP_F = 0x00c1,
# define WINDOW_KEYCODE_KP_F WINDOW_KEYCODE_KP_F

    WINDOW_KEYCODE_KP_XOR = 0x00c2,
# define WINDOW_KEYCODE_KP_XOR WINDOW_KEYCODE_KP_XOR

    WINDOW_KEYCODE_KP_CARET = 0x00c3,
# define WINDOW_KEYCODE_KP_CARET WINDOW_KEYCODE_KP_CARET

    WINDOW_KEYCODE_KP_PERCENT = 0x00c4,
# define WINDOW_KEYCODE_KP_PERCENT WINDOW_KEYCODE_KP_PERCENT

    WINDOW_KEYCODE_KP_LESS = 0x00c5,
# define WINDOW_KEYCODE_KP_LESS WINDOW_KEYCODE_KP_LESS

    WINDOW_KEYCODE_KP_GREAT = 0x00c6,
# define WINDOW_KEYCODE_KP_GREAT WINDOW_KEYCODE_KP_GREAT

    WINDOW_KEYCODE_KP_BITAND = 0x00c7,
# define WINDOW_KEYCODE_KP_BITAND WINDOW_KEYCODE_KP_BITAND

    WINDOW_KEYCODE_KP_LOGICAND = 0x00c8,
# define WINDOW_KEYCODE_KP_LOGICAND WINDOW_KEYCODE_KP_LOGICAND

    WINDOW_KEYCODE_KP_BITOR = 0x00c9,
# define WINDOW_KEYCODE_KP_BITOR WINDOW_KEYCODE_KP_BITOR

    WINDOW_KEYCODE_KP_LOGICOR = 0x00ca,
# define WINDOW_KEYCODE_KP_LOGICOR WINDOW_KEYCODE_KP_LOGICOR

    WINDOW_KEYCODE_KP_COLON = 0x00cb,
# define WINDOW_KEYCODE_KP_COLON WINDOW_KEYCODE_KP_COLON

    WINDOW_KEYCODE_KP_HASH = 0x00cc,
# define WINDOW_KEYCODE_KP_HASH WINDOW_KEYCODE_KP_HASH

    WINDOW_KEYCODE_KP_SPACE = 0x00cd,
# define WINDOW_KEYCODE_KP_SPACE WINDOW_KEYCODE_KP_SPACE

    WINDOW_KEYCODE_KP_AT = 0x00ce,
# define WINDOW_KEYCODE_KP_AT WINDOW_KEYCODE_KP_AT

    WINDOW_KEYCODE_KP_EXCLAIM = 0x00cf,
# define WINDOW_KEYCODE_KP_EXCLAIM WINDOW_KEYCODE_KP_EXCLAIM

    WINDOW_KEYCODE_KP_MEMORYSTORE = 0x00d0,
# define WINDOW_KEYCODE_KP_MEMORYSTORE WINDOW_KEYCODE_KP_MEMORYSTORE

    WINDOW_KEYCODE_KP_MEMORYRECALL = 0x00d1,
# define WINDOW_KEYCODE_KP_MEMORYRECALL WINDOW_KEYCODE_KP_MEMORYRECALL

    WINDOW_KEYCODE_KP_MEMORYCLEAR = 0x00d2,
# define WINDOW_KEYCODE_KP_MEMORYRECALL WINDOW_KEYCODE_KP_MEMORYRECALL

    WINDOW_KEYCODE_KP_MEMORYADD = 0x00d3,
# define WINDOW_KEYCODE_KP_MEMORYADD WINDOW_KEYCODE_KP_MEMORYADD

    WINDOW_KEYCODE_KP_MEMORYSUBSTRACT = 0x00d4,
# define WINDOW_KEYCODE_KP_MEMORYSUBSTRACT WINDOW_KEYCODE_KP_MEMORYSUBSTRACT

    WINDOW_KEYCODE_KP_MEMORYMULTIPLY = 0x00d5,
# define WINDOW_KEYCODE_KP_MEMORYMULTIPLY WINDOW_KEYCODE_KP_MEMORYMULTIPLY

    WINDOW_KEYCODE_KP_MEMORYDIVIDE = 0x00d6,
# define WINDOW_KEYCODE_KP_MEMORYDIVIDE WINDOW_KEYCODE_KP_MEMORYDIVIDE

    WINDOW_KEYCODE_KP_PLUSMINUS = 0x00d7,
# define WINDOW_KEYCODE_KP_PLUSMINUS WINDOW_KEYCODE_KP_PLUSMINUS

    WINDOW_KEYCODE_KP_CLEAR = 0x00d8,
# define WINDOW_KEYCODE_KP_CLEAR WINDOW_KEYCODE_KP_CLEAR

    WINDOW_KEYCODE_KP_CLEARENTRY = 0x00d9,
# define WINDOW_KEYCODE_KP_CLEARENTRY WINDOW_KEYCODE_KP_CLEARENTRY

    WINDOW_KEYCODE_KP_BINARY = 0x00da,
# define WINDOW_KEYCODE_KP_BINARY WINDOW_KEYCODE_KP_BINARY

    WINDOW_KEYCODE_KP_OCTAL = 0x00db,
# define WINDOW_KEYCODE_KP_OCTAL WINDOW_KEYCODE_KP_OCTAL

    WINDOW_KEYCODE_KP_DECIMAL = 0x00dc,
# define WINDOW_KEYCODE_KP_DECIMAL WINDOW_KEYCODE_KP_DECIMAL

    WINDOW_KEYCODE_KP_HEXADECIMAL = 0x00dd,
# define WINDOW_KEYCODE_KP_HEXADECIMAL WINDOW_KEYCODE_KP_HEXADECIMAL

    /* 0x00de - 0x00df: reserved */

    WINDOW_KEYCODE_LEFTCTRL = 0x00e0,
# define WINDOW_KEYCODE_LEFTCTRL WINDOW_KEYCODE_LEFTCTRL

    WINDOW_KEYCODE_LEFTSHIFT = 0x00e1,
# define WINDOW_KEYCODE_LEFTSHIFT WINDOW_KEYCODE_LEFTSHIFT

    WINDOW_KEYCODE_LEFTALT = 0x00e2,
# define WINDOW_KEYCODE_LEFTALT WINDOW_KEYCODE_LEFTALT

    WINDOW_KEYCODE_LEFTGUI = 0x00e3,
# define WINDOW_KEYCODE_LEFTGUI WINDOW_KEYCODE_LEFTGUI

    WINDOW_KEYCODE_RIGHTCTRL = 0x00e4,
# define WINDOW_KEYCODE_RIGHTCTRL WINDOW_KEYCODE_RIGHTCTRL

    WINDOW_KEYCODE_RIGHTSHIFT = 0x00e5,
# define WINDOW_KEYCODE_RIGHTSHIFT WINDOW_KEYCODE_RIGHTSHIFT

    WINDOW_KEYCODE_RIGHTALT = 0x00e6,
# define WINDOW_KEYCODE_RIGHTALT WINDOW_KEYCODE_RIGHTALT

    WINDOW_KEYCODE_RIGHTGUI = 0x00e7,
# define WINDOW_KEYCODE_RIGHTGUI WINDOW_KEYCODE_RIGHTGUI
...
# define WINDOW_KEYSYM_BACKSPACE WINDOW_KEYSYM_BACKSPACE
    
    WINDOW_KEYSYM_TAB = 0x0009,
# define WINDOW_KEYSYM_TAB WINDOW_KEYSYM_TAB
    
    WINDOW_KEYSYM_RETURN = 0x000d,
# define WINDOW_KEYSYM_RETURN WINDOW_KEYSYM_RETURN
    
    WINDOW_KEYSYM_ESCAPE = 0x001b,
# define WINDOW_KEYSYM_ESCAPE WINDOW_KEYSYM_ESCAPE
    
    WINDOW_KEYSYM_SPACE = 0x0020,
# define WINDOW_KEYSYM_SPACE WINDOW_KEYSYM_SPACE

    WINDOW_KEYSYM_EXCLAIM = 0x0021,
# define WINDOW_KEYSYM_EXCLAIM WINDOW_KEYSYM_EXCLAIM

    WINDOW_KEYSYM_DOUBLEQUOTE = 0x0022,
# define WINDOW_KEYSYM_DOUBLEQUOTE WINDOW_KEYSYM_DOUBLEQUOTE

    WINDOW_KEYSYM_HASH = 0x0023,
# define WINDOW_KEYSYM_HASH WINDOW_KEYSYM_HASH

    WINDOW_KEYSYM_DOLLAR = 0x0024,
# define WINDOW_KEYSYM_DOLLAR WINDOW_KEYSYM_DOLLAR

    WINDOW_KEYSYM_PERCENT = 0x0025,
# define WINDOW_KEYSYM_PERCENT WINDOW_KEYSYM_PERCENT

    WINDOW_KEYSYM_AMPERSAND = 0x0026,
# define WINDOW_KEYSYM_AMPERSAND WINDOW_KEYSYM_AMPERSAND

    WINDOW_KEYSYM_QUOTE = 0x0027,
# define WINDOW_KEYSYM_QUOTE WINDOW_KEYSYM_QUOTE

    WINDOW_KEYSYM_OPENPAREN = 0x0028,
# define WINDOW_KEYSYM_OPENPAREN WINDOW_KEYSYM_OPENPAREN

    WINDOW_KEYSYM_CLOSEPAREN = 0x0029,
# define WINDOW_KEYSYM_CLOSEPAREN WINDOW_KEYSYM_CLOSEPAREN

    WINDOW_KEYSYM_ASTERISK = 0x002a,
# define WINDOW_KEYSYM_ASTERISK WINDOW_KEYSYM_ASTERISK

    WINDOW_KEYSYM_PLUS = 0x002b,
# define WINDOW_KEYSYM_PLUS WINDOW_KEYSYM_PLUS

    WINDOW_KEYSYM_COMMA = 0x002c,
# define WINDOW_KEYSYM_COMMA WINDOW_KEYSYM_COMMA

    WINDOW_KEYSYM_MINUS = 0x002d,
# define WINDOW_KEYSYM_MINUS WINDOW_KEYSYM_MINUS

    WINDOW_KEYSYM_PERIOD = 0x002e,
# define WINDOW_KEYSYM_PERIOD WINDOW_KEYSYM_PERIOD

    WINDOW_KEYSYM_SLASH = 0x002f,
# define WINDOW_KEYSYM_SLASH WINDOW_KEYSYM_SLASH

    WINDOW_KEYSYM_0 = 0x0030,
# define WINDOW_KEYSYM_0 WINDOW_KEYSYM_0

    WINDOW_KEYSYM_1 = 0x0031,
# define WINDOW_KEYSYM_1 WINDOW_KEYSYM_1

    WINDOW_KEYSYM_2 = 0x0032,
# define WINDOW_KEYSYM_2 WINDOW_KEYSYM_2

    WINDOW_KEYSYM_3 = 0x0033,
# define WINDOW_KEYSYM_3 WINDOW_KEYSYM_3

    WINDOW_KEYSYM_4 = 0x0034,
# define WINDOW_KEYSYM_4 WINDOW_KEYSYM_4

    WINDOW_KEYSYM_5 = 0x0035,
# define WINDOW_KEYSYM_5 WINDOW_KEYSYM_5

    WINDOW_KEYSYM_6 = 0x0036,
# define WINDOW_KEYSYM_6 WINDOW_KEYSYM_6

    WINDOW_KEYSYM_7 = 0x0037,
# define WINDOW_KEYSYM_7 WINDOW_KEYSYM_7

    WINDOW_KEYSYM_8 = 0x0038,
# define WINDOW_KEYSYM_8 WINDOW_KEYSYM_8

    WINDOW_KEYSYM_9 = 0x0039,
# define WINDOW_KEYSYM_9 WINDOW_KEYSYM_9

    WINDOW_KEYSYM_COLON = 0x003a,
# define WINDOW_KEYSYM_COLON WINDOW_KEYSYM_COLON

    WINDOW_KEYSYM_SEMICOLON = 0x003b,
# define WINDOW_KEYSYM_SEMICOLON WINDOW_KEYSYM_SEMICOLON

    WINDOW_KEYSYM_LESS = 0x003c,
# define WINDOW_KEYSYM_LESS WINDOW_KEYSYM_LESS

    WINDOW_KEYSYM_EQUAL = 0x003d,
# define WINDOW_KEYSYM_EQUAL WINDOW_KEYSYM_EQUAL

    WINDOW_KEYSYM_GREATER = 0x003e,
# define WINDOW_KEYSYM_GREATER WINDOW_KEYSYM_GREATER

    WINDOW_KEYSYM_QUESTION = 0x003f,
# define WINDOW_KEYSYM_QUESTION WINDOW_KEYSYM_QUESTION

    WINDOW_KEYSYM_AT = 0x0040,
# define WINDOW_KEYSYM_AT WINDOW_KEYSYM_AT

    WINDOW_KEYSYM_A = 0x0041,
# define WINDOW_KEYSYM_A WINDOW_KEYSYM_A

    WINDOW_KEYSYM_B = 0x0042,
# define WINDOW_KEYSYM_B WINDOW_KEYSYM_B

    WINDOW_KEYSYM_C = 0x0043,
# define WINDOW_KEYSYM_C WINDOW_KEYSYM_C

    WINDOW_KEYSYM_D = 0x0044,
# define WINDOW_KEYSYM_D WINDOW_KEYSYM_D

    WINDOW_KEYSYM_E = 0x0045,
# define WINDOW_KEYSYM_E WINDOW_KEYSYM_E

    WINDOW_KEYSYM_F = 0x0046,
# define WINDOW_KEYSYM_F WINDOW_KEYSYM_F

    WINDOW_KEYSYM_G = 0x0047,
# define WINDOW_KEYSYM_G WINDOW_KEYSYM_G

    WINDOW_KEYSYM_H = 0x0048,
# define WINDOW_KEYSYM_H WINDOW_KEYSYM_H

    WINDOW_KEYSYM_I = 0x0049,
# define WINDOW_KEYSYM_I WINDOW_KEYSYM_I
...
# define WINDOW_KEYSYM_PIPE WINDOW_KEYSYM_PIPE
    
    WINDOW_KEYSYM_CLOSECURLY = 0x007d,
# define WINDOW_KEYSYM_CLOSECURLY WINDOW_KEYSYM_CLOSECURLY
    
    WINDOW_KEYSYM_TILDE = 0x007e,
# define WINDOW_KEYSYM_TILDE WINDOW_KEYSYM_TILDE
    
    WINDOW_KEYSYM_DELETE = 0x007f,
# define WINDOW_KEYSYM_DELETE WINDOW_KEYSYM_DELETE
...
# define WINDOW_KEYMOD_LEFTCTRL WINDOW_KEYMOD_LEFTCTRL

    WINDOW_KEYMOD_LEFTSHIFT = 0x0002,
# define WINDOW_KEYMOD_LEFTSHIFT WINDOW_KEYMOD_LEFTSHIFT

    WINDOW_KEYMOD_LEFTALT = 0x0004,
# define WINDOW_KEYMOD_LEFTALT WINDOW_KEYMOD_LEFTALT

    WINDOW_KEYMOD_LEFTGUI = 0x0008,
# define WINDOW_KEYMOD_LEFTGUI WINDOW_KEYMOD_LEFTGUI

    WINDOW_KEYMOD_RIGHTCTRL = 0x0010,
# define WINDOW_KEYMOD_RIGHTCTRL WINDOW_KEYMOD_RIGHTCTRL

    WINDOW_KEYMOD_RIGHTSHIFT = 0x0020,
# define WINDOW_KEYMOD_RIGHTSHIFT WINDOW_KEYMOD_RIGHTSHIFT

    WINDOW_KEYMOD_RIGHTALT = 0x0010,
# define WINDOW_KEYMOD_RIGHTALT WINDOW_KEYMOD_RIGHTALT

    WINDOW_KEYMOD_RIGHTGUI = 0x0020,
# define WINDOW_KEYMOD_RIGHTGUI WINDOW_KEYMOD_RIGHTGUI

    WINDOW_KEYMOD_NUMLOCK = 0x0100,
# define WINDOW_KEYMOD_NUMLOCK WINDOW_KEYMOD_NUMLOCK

    WINDOW_KEYMOD_SCROLLLOCK = 0x0200,
# define WINDOW_KEYMOD_SCROLLLOCK WINDOW_KEYMOD_SCROLLLOCK

    WINDOW_KEYMOD_MODE = 0x0400,
# define WINDOW_KEYMOD_MODE WINDOW_KEYMOD_MODE

    WINDOW_KEYMOD_CAPSLOCK = 0x0800,
# define WINDOW_KEYMOD_CAPSLOCK WINDOW_KEYMOD_CAPSLOCK

    WINDOW_KEYMOD_CTRL = (WINDOW_KEYMOD_LEFTCTRL | WINDOW_KEYMOD_RIGHTCTRL),
# define WINDOW_KEYMOD_CTRL WINDOW_KEYMOD_CTRL

    WINDOW_KEYMOD_SHIFT = (WINDOW_KEYMOD_LEFTSHIFT | WINDOW_KEYMOD_RIGHTSHIFT),
# define WINDOW_KEYMOD_SHIFT WINDOW_KEYMOD_SHIFT

    WINDOW_KEYMOD_ALT = (WINDOW_KEYMOD_LEFTALT | WINDOW_KEYMOD_RIGHTALT),
# define WINDOW_KEYMOD_ALT WINDOW_KEYMOD_ALT

    WINDOW_KEYMOD_GUI = (WINDOW_KEYMOD_LEFTGUI | WINDOW_KEYMOD_RIGHTGUI),
# define WINDOW_KEYMOD_GUI WINDOW_KEYMOD_GUI
